...
public class OpenAiEmbeddingProvider implements EmbeddingProvider {
    ...
    public OpenAiEmbeddingProvider(
            ...
            @Value("${assistant.embedding.openai.api-key:}") String apiKey,
            @Value("${assistant.embedding.openai.model:text-embedding-3-small}") String model,
            @Value("${assistant.embedding.openai.url:https://api.openai.com/v1/embeddings}") String url
    ) {
